...
namespace PolarityRunner
{
	...
	public class AudioManager : MonoBehaviour
	{
		...
		private AudioClip m_PolaritySwitchSound;
		...
		{
			if (m_MusicAudioSource == null || m_MusicClip == null) {
				Debug.LogWarning ("Audio Manager is missing its music source or music clip.", this);
				return;
			}
			m_MusicAudioSource.loop = true;
			if (m_MusicAudioSource.clip != m_MusicClip) {
			...
			} else if (!m_MusicAudioSource.isPlaying) {
		...
		public void PlaySoundOn (AudioSource audio, AudioClip clip)
		{
			if (audio == null || clip == null) {
				Debug.LogWarning ("Audio Manager could not play a sound because its source or clip is missing.", this);
				return;
			}
			audio.clip = clip;
			audio.Play ();
		...
		public void PlayPolaritySwitchSound ()
		{
			if (m_PolaritySwitchSound == null) {
				m_PolaritySwitchSound = Resources.Load<AudioClip> ("PolaritySwitch");
			}
			PlaySoundOn (m_UIAudioSource, m_PolaritySwitchSound);
		}
