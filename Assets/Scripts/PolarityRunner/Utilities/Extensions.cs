...
namespace PolarityRunner.Utilities
{

	public static class Extensions
	{
		public const float WorldUnitsPerMeter = 10f;
		...
		public static float modifier = 1f / WorldUnitsPerMeter;

		public static float ToWorldUnits ( this float meters )
		{
